<template>
  <div v-bind:id="'popupDiv'+popId" class="mapPop"
       v-bind:ref="'rpaPop-'+levelNum" v-on:click="clickStick('popupDiv'+popId)">
    ...
    <div class="mapPop-content" style="border-color:#00d3e788;">
      ...
      <div class="pop-chart">
        <div class="pop-chart-row">
          <div v-bind:id="popId+'chart_rpa1'" class="pop-chart-single"></div>
          <div v-bind:id="popId+'chart_rpa2'" class="pop-chart-single"></div>
        </div>
        <div class="pop-chart-row">
          <div v-bind:id="popId+'chart_rpa3'" class="pop-chart-single"></div>
          <div v-bind:id="popId+'chart_rpa4'" class="pop-chart-single"></div>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      showChart() {
        ...
        let rpaChart2 = this.$echarts.init(document.getElementById(this.popId+"chart_rpa2"), 'light');
        let rpaChart3 = this.$echarts.init(document.getElementById(this.popId+"chart_rpa3"), 'light');
        let rpaChart4 = this.$echarts.init(document.getElementById(this.popId+"chart_rpa4"), 'light');
        let rpaOption1 = {
          title: {
            text: '就业',
            left: 'center',
        ...
        let rpaOption2 = {
          ...
          legend: {
            ...
            orient: 'vertical',
            x: 'left',
            data: ['重点人员', '监管对象', '吸毒人员', '上访人员', '精神病人员']
          },
          series: [
            {
              name: '人口类别',
        ...
        rpaChart2.setOption(rpaOption2);
        rpaChart3.setOption(rpaOption3);
        rpaChart4.setOption(rpaOption4);
      },
      pop_in(){
        realPeople.methods.stepInNextLevel(this.popId);
      },
      pop_close() {
        let pop = this.$refs['rpaPop-' + this.levelNum];
        if (pop) {
